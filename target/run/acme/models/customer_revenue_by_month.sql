  ...
  create or replace  view MRR_ANALYSIS.MRR_ANALYSIS.customer_revenue_by_month
  
   as (
    with subscription_periods as (

    select * from MRR_ANALYSIS.MRR_ANALYSIS.subscription_periods

),

months as (

    select * from MRR_ANALYSIS.MRR_ANALYSIS.util_months
